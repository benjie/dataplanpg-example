...
export interface TypedGrafastSchemaSpec extends Omit<GrafastSchemaConfig, 'objects' | 'interfaces' | 'unions' | 'inputObjects' | 'scalars' | 'enums'> {
  objects?: {
    ...
    Query?: Omit<ObjectPlan<Get<"Query", "source", NonNullStep<Get<"Query", "nullable", Step>>>>, 'plans'> & {
      plans?: {
        posts?: FieldPlan<Get<"Query", "source", NonNullStep<Get<"Query", "nullable", Step>>>, NoArguments, ListOfStep<Get<"Post", "nullable", Step>>>;
        users?: FieldPlan<Get<"Query", "source", NonNullStep<Get<"Query", "nullable", Step>>>, NoArguments, ListOfStep<Get<"User", "nullable", Step>>>;
      }
    };
    User?: Omit<ObjectPlan<Get<"User", "source", NonNullStep<Get<"User", "nullable", Step>>>>, 'plans'> & {
      plans?: {
        ...
        posts?: FieldPlan<Get<"User", "source", NonNullStep<Get<"User", "nullable", Step>>>, NoArguments, ListOfStep<Get<"Post", "nullable", Step>>>;
